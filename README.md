...
- `GEOIP_URL`: (Optional) Direct download link for a MaxMind `GeoLite2-City.mmdb` (or `.tar.gz`). If provided, the app will automatically download the database on startup (if missing) and update it every 72 hours.
